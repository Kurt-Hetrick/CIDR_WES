...
START_COLLECT_MULTIPLE_METRICS=`date '+%s'` # capture time process starts for wall clock tracking purposes.
	...
	# construct command line
		...
		CMD=${CMD}" CollectMultipleMetrics"
			...
			CMD=${CMD}" INTERVALS=${CORE_PATH}/${PROJECT}/TEMP/${SM_TAG}/${SM_TAG}-${TARGET_BED_NAME}-picard.bed"
		...
		CMD=${CMD}" &&"
			CMD=${CMD}" mv -v ${CORE_PATH}/${PROJECT}/TEMP/${SM_TAG}/${SM_TAG}.pre_adapter_detail_metrics"
			CMD=${CMD}" ${CORE_PATH}/${PROJECT}/REPORTS/PRE_ADAPTER/METRICS/${SM_TAG}.pre_adapter_detail_metrics.txt"
		CMD=${CMD}" &&"
			CMD=${CMD}" mv -v ${CORE_PATH}/${PROJECT}/TEMP/${SM_TAG}/${SM_TAG}.pre_adapter_summary_metrics"
		...
		CMD=${CMD}" &&"
			CMD=${CMD}" mv -v ${CORE_PATH}/${PROJECT}/TEMP/${SM_TAG}/${SM_TAG}.alignment_summary_metrics"
		...
		CMD=${CMD}" &&"
			CMD=${CMD}" mv -v ${CORE_PATH}/${PROJECT}/TEMP/${SM_TAG}/${SM_TAG}.base_distribution_by_cycle.pdf"
			CMD=${CMD}" ${CORE_PATH}/${PROJECT}/REPORTS/BASE_DISTRIBUTION_BY_CYCLE/PDF/${SM_TAG}.base_distribution_by_cycle.pdf"
		CMD=${CMD}" &&"
			CMD=${CMD}" mv -v ${CORE_PATH}/${PROJECT}/TEMP/${SM_TAG}/${SM_TAG}.base_distribution_by_cycle_metrics"
		...
		CMD=${CMD}" &&"
			CMD=${CMD}" mv -v ${CORE_PATH}/${PROJECT}/TEMP/${SM_TAG}/${SM_TAG}.insert_size_histogram.pdf"
			CMD=${CMD}" ${CORE_PATH}/${PROJECT}/REPORTS/INSERT_SIZE/PDF/${SM_TAG}.insert_size_histogram.pdf"
		CMD=${CMD}" &&"
			CMD=${CMD}" mv -v ${CORE_PATH}/${PROJECT}/TEMP/${SM_TAG}/${SM_TAG}.insert_size_metrics"
		...
		CMD=${CMD}" &&"
			CMD=${CMD}" mv -v ${CORE_PATH}/${PROJECT}/TEMP/${SM_TAG}/${SM_TAG}.quality_by_cycle.pdf"
			CMD=${CMD}" ${CORE_PATH}/${PROJECT}/REPORTS/MEAN_QUALITY_BY_CYCLE/PDF/${SM_TAG}.quality_by_cycle.pdf"
		CMD=${CMD}" &&"
			CMD=${CMD}" mv -v ${CORE_PATH}/${PROJECT}/TEMP/${SM_TAG}/${SM_TAG}.quality_by_cycle_metrics"
		...
		CMD=${CMD}" &&"
			CMD=${CMD}" mv -v ${CORE_PATH}/${PROJECT}/TEMP/${SM_TAG}/${SM_TAG}.quality_distribution.pdf"
			CMD=${CMD}" ${CORE_PATH}/${PROJECT}/REPORTS/BASECALL_Q_SCORE_DISTRIBUTION/PDF/${SM_TAG}.quality_distribution.pdf"
		CMD=${CMD}" &&"
			CMD=${CMD}" mv -v ${CORE_PATH}/${PROJECT}/TEMP/${SM_TAG}/${SM_TAG}.quality_distribution_metrics"
		...
		CMD=${CMD}" &&"
			CMD=${CMD}" mv -v ${CORE_PATH}/${PROJECT}/TEMP/${SM_TAG}/${SM_TAG}.gc_bias.pdf"
			CMD=${CMD}" ${CORE_PATH}/${PROJECT}/REPORTS/GC_BIAS/PDF/${SM_TAG}.gc_bias.pdf"
		CMD=${CMD}" &&"
			CMD=${CMD}" mv -v ${CORE_PATH}/${PROJECT}/TEMP/${SM_TAG}/${SM_TAG}.gc_bias.detail_metrics"
			CMD=${CMD}" ${CORE_PATH}/${PROJECT}/REPORTS/GC_BIAS/METRICS/${SM_TAG}.gc_bias.detail_metrics.txt"
		CMD=${CMD}" &&"
			CMD=${CMD}" mv -v ${CORE_PATH}/${PROJECT}/TEMP/${SM_TAG}/${SM_TAG}.gc_bias.summary_metrics"
		...
		CMD=${CMD}" &&"
			CMD=${CMD}" mv -v ${CORE_PATH}/${PROJECT}/TEMP/${SM_TAG}/${SM_TAG}.quality_yield_metrics"
		...
		CMD=${CMD}" &&"
			CMD=${CMD}" mv -v ${CORE_PATH}/${PROJECT}/TEMP/${SM_TAG}/${SM_TAG}.error_summary_metrics"
